...
namespace NeuralNetwork1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            Sample fig = generator.GenerateButton(processor.ProcessImage2(img));
            net.Predict(fig);
        ...
        private async Task<double> train_networkAsync( int epoches, double acceptable_error, bool parallel = true)
        {
            ...
            for (int i = 0; i < (int)classCounter.Value; i++)
            {
                ...
                for (int j = 0; j < cnt - 1; j++)
                {
                    ...
                    Sample fig = generator.GenerateButton(processor.ProcessImage2((Bitmap)img), smp);
        ...
        private void btnTrainOne_Click(object sender, EventArgs e)
        {
            ...
            var v = processor.ProcessImage2((Bitmap)img);
            Sample fig = generator.GenerateButton(processor.ProcessImage2((Bitmap)img),  KindOfObjextComboBox.SelectedIndex) as Sample;
            pictureBox1.Image = generator.genBitmap();
            pictureBox1.Invalidate();
            net.Train(fig, false);
            set_result(fig);
